...
router
    ...
    .post(authenticateJWT, tripsController.tripsAddTrip); // POST Method Adds a Trip (authentication middleware injection)

// GET Method routes tripsFindByCode - requires parameter
router
    .route('/trips/:tripCode')
    .get(tripsController.tripsFindByCode) // GET Method routes tripFindByCode
    .put(authenticateJWT, tripsController.tripsUpdateTrip) // PUT Method routes tripUpdateTrip (authentication middleware injection)
